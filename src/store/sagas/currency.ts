...
export function* fetchCurrencyData({payload}: ReturnType<typeof currencySlice.actions.loadCurrencyRequest>) {
...
export function* fetchCurrencyHistoryData({payload}: ReturnType<typeof currencySlice.actions.historyDataRequest>) {
